...
from net.gwngames.pubscraper.scraper.scraper import ScholarScraper
    ...
    def prepare_next_phase(self, phase_ref: int, current_entity: Document) -> tuple[list[GeneralDataAdapter], dict]:
        ...
        if (phase_ref == EntityCidConstants.GOOGLE_SCHOLAR_AUTHOR
            ...
            for citation_year in cit_graph:
                self.generate_adapter_with_prio(EntityCidConstants.GOOGLE_SCHOLAR_CIT, PriorityConstants.CIT_REQ, citation_year['citation_link'], citation_year['citation_link'])
